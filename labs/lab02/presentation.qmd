...
- **Базовая конфигурация**: 
  ```bash
  git config --global user.name "Wang Haojian"
...
- **RSA 4096 бит**: `ssh-keygen -t rsa -b 4096 -C ""`
- **Ed25519**: `ssh-keygen -t ed25519 -C ""`
...
- **Параметры ключа**: тип RSA and RSA, размер 4096 бит, срок действия бессрочно, имя Wang Haojian, email 
- **Просмотр и экспорт**: 
  ```bash
...
- **Клонирование репозитория**: 
  ```bash
  git clone --recursive git@github.com:haoczan2/study_2026-2027_os-intro.git os-intro
  cd os-intro
  ```
